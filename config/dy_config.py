...
# ==================== 私信发送配置 ====================
# 私信消息模板，支持占位符: {nickname} 用户昵称, {comment} 用户评论内容(前20字)
DM_MESSAGE = "你好{nickname}，看到你的评论很有意思，想和你交流一下～"

# 私信发送间隔（秒），随机在最小和最大值之间取值，避免被风控
DM_INTERVAL_MIN = 60   # 两次私信之间最少等待60秒
DM_INTERVAL_MAX = 180  # 两次私信之间最多等待180秒
