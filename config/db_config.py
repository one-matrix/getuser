...
# postgres config
POSTGRES_DB_PWD = os.getenv("DB_PASSWORD", "123456")
POSTGRES_DB_USER = os.getenv("DB_USER", "postgres")
POSTGRES_DB_HOST = os.getenv("DB_HOST", "localhost")
POSTGRES_DB_PORT = os.getenv("DB_PORT", 5432)
POSTGRES_DB_NAME = os.getenv("DB_NAME", "media_crawler")
