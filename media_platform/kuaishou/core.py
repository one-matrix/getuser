...
class KuaishouCrawler(AbstractCrawler):
    ...
    async def start(self):
        ...
        try:
            ...
            self._account_pool = await init_platform_account_pool("ks", logger=utils.logger)
        except Exception as e:
            utils.logger.warning(f"[KuaishouCrawler.start] init account_pool failed (non-fatal): {e}")
